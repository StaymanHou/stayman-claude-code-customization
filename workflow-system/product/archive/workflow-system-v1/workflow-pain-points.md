...
> **Status: All pain points addressed — 2026-05-01.** PP1 (Work Tree + leaf-level pass/fail, WP1–WP5/WP9), PP2 (verify-self + behavioral DoD + severity taxonomy, WP6–WP8/WP14), PP3 (learning-sequence ordering + probe WP class, WP10–WP11). Framework gaps F1/F4/F5 closed in WP12. Hardened in WP13 (85 scenarios, check-structure.sh, CLAUDE.md, argument-hints).
