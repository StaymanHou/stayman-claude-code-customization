...
- **Order:** P1 (promoted from MAYBE 2026-06-12 — Stayman: next session continues here first)
...
- **Priority:** medium — the failure mode hit twice in past sessions (lost work recovered only via transcript); the rule applies to every cross-feature pause/resume going forward.
...
- **Order:** P2 (promoted from MAYBE 2026-06-12 — Stayman: session after P1)
